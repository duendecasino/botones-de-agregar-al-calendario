document.getElementById('calendar-generator').onsubmit = function() {
  ...
  // Obtener valores para el calendario
  ...
  // Asegúrese de pasar la información básica
  if (!(title && start && end)) {
    console.log('Agrega algunos detalles');
    return false;
  }
  ...
  // Agregue el resultado del calendario y un ejemplo
  ...
  document.getElementById('html-result').innerHTML += '<p class="instructions">Copia y pega este codigo:</p>';
